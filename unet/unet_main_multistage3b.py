...
#     CHANNELS = 3
    ...
    for imgfile in ff:
        ...
        cy = int(cy/2.0) # to downsize 1024 (Mrcnn output) to 512 (U-Net)

        ai_reading, distances = measure_prediction_output(domain, item, int(cx), int(cy), -1, test_src=image_name, settings=settings )
