...
#         ai_reading = measure_prediction_output(domain, item, int(cx), int(cy), -1)
    ...
    output_file = "{}/{}/unet_rd_{}_{}_of_{}.txt".format(domain, name, exact_reading, offbyone_reading, len(ff) )
