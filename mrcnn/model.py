...
sys.path.append("{}/otoliths/autoliths/".format(os.getcwd()))
from mrcnn import utils
...
class MaskRCNN():
    ...
    def set_log_dir(self, model_path=None):
        ...
        checkpoint_dir = "{}/".format(self.model_dir)
        #if not os.path.exists(checkpoint_dir):
        #    os.makedirs(checkpoint_dir)
        self.checkpoint_path = os.path.join(checkpoint_dir, "mrcnn_checkpoint.h5")
        # Path to save after each epoch. Include placeholders that get filled by Keras.
#         self.checkpoint_path = os.path.join(checkpoint_dir, "mask_rcnn_{}_*epoch*.h5".format(
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        callbacks = [
            ...
            keras.callbacks.ModelCheckpoint(self.checkpoint_path,
                                            verbose=0, save_weights_only=True, save_best_only=True, period=1),
        ]
